                            ...
                            <ul className="flex space-x-8 text-2xl font-semibold list-none text-bg-600 ">
                                ...
                                >
                                    <NavLink to="/payment">
                                        <button
                                            type="button"
                                            className="w-52 h-16 text-white bg-main-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-3xl text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                        >
